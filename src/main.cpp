...
int64 nChainStartTime = 1402491601;
...
const string strMessageMagic = "DijkstraCoin Signed Message:\n";
...
const int YEARLY_BLOCKCOUNT = 1051200;	// 365 * 24 * 60 * 2
...
static const int64 nTargetTimespan = 10 * 60;  //10 min
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        nStakeTargetSpacing =60; // test block spacing is 3 minutes
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
		const char* pszTimestamp = "11/6/2014, Bitcoin, Height:305260, BlockHash:000...64ddd0bc2b0b4c276aa2a1";
        CTransaction txNew;
        ...
        //block.nNonce   = 1509831;
		block.nNonce   = !fTestNet ? 1560728 : 216485;
        ...
        while (hashGenesisNew > bnProofOfWorkLimit.getuint256()){
			...
			//printf("nonce=%u hashGenesisNew=%s\n",blockGenesis.nNonce, hashGenesisNew.ToString().c_str());
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x20639481ef0fdf31db08253b5d2d0f0b0048e7228f27dd82e32f21ae20946292"));
